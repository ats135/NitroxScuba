...
//=============================================================================
public class NitroxScubapractice {
    //-----------------------------------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ambient Pressure :" + ambientPressure);
        double partialPressure = computePartialPressure(ambientPressure, percentO);
        System.out.print("O2 Pressure :" + partialPressure);
        ...
        System.out.print("Exceeds maximal O2 pressure: " + partialPressure1);
